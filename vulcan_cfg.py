...
sflux_file = '/scratch/s2555875/stellar_flux/early_sun_cut.txt' # This is the flux density at the stellar surface
...
out_name = 'archean_ncho_stellarcut.vul' # output file name
