...
def plot_hist(df, bins = 50, figsave = False, rain_type = 'HCN_rain', met_flux = True):
    ...
    if met_flux:
        ax.axvline(max_flux_met, c = 'gray', lw = 2, ls = '--', label = 'Maximum meteoritic flux')
...
def plot_meshgrid_hist(data, rain_type = 'HCN_rain', bins = 50, figsave = False):
    ...
    ax[1].axvline(max_flux_met, c = 'gray', lw = 2, ls = '--', label = 'Max meteoritic flux')
    ax[1].axvline(1.835e-5, c = 'k', ls = '--', lw = 2, label = 'Archean Earth')
...
def plot_box_star(dat, rain_type = 'HCN_rain', figsave = False):
    ...
    fig, ax = plt.subplots(tight_layout = True)
    ax.axhline(max_flux_met, c = 'gray', lw = 2, ls = '--', label = 'Max meteoritic flux')
    ax.axhline(rainout(data_archean), c = archean_colour, lw = 2, ls = '--', label = 'Archean Earth')
